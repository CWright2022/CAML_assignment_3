To run this code, you must unzip the feature_vectors.zip file (the zip is too large to include in this repo)

The directory structure should look like

- dataset
    - feature_vectors
        - [all extracted feature vector files]
...
You will need both to load the data into your program correctly.
